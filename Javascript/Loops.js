...
for (let i = 0; i < alphabet.length; i ++) {
    if (i % 2 === 0) {
        ...
        console.log(`The index of ${alphabet[]} is an odd number`)
    }
}
...
//FOR OF LOOPS
// A FOR OF LOOP will cycle through an interablke collection
// iteratable - a thing that can be iterated on, repeat for every elemant in the collection.
...
// Print this for each character: " ______ is weilding ______"
